...
public class CardCombiner
{
    ...
    // Elemental synergy bonuses - new elements have thematic relationships
    private static readonly Dictionary<(ElementType, ElementType), string> ElementSynergies = new()
    {
        { (ElementType.Radioactivity, ElementType.Toxin), "Contaminated" },
        { (ElementType.Radioactivity, ElementType.Flesh), "Mutated" },
        { (ElementType.Radioactivity, ElementType.Fungus), "Irradiated Growth" },
        { (ElementType.Flesh, ElementType.Fungus), "Necrotic" },
        { (ElementType.Flesh, ElementType.Toxin), "Virulent" },
        { (ElementType.Toxin, ElementType.Fungus), "Bioluminescent" },
        { (ElementType.Thermodynamics, ElementType.Radioactivity), "Fusion" },
        { (ElementType.Thermodynamics, ElementType.Time), "Entropy" },
        { (ElementType.Time, ElementType.Eldritch), "Cosmic" },
        { (ElementType.Food, ElementType.Flesh), "Sustenance" },
        { (ElementType.Food, ElementType.Fungus), "Fermented" },
        { (ElementType.Eldritch, ElementType.Flesh), "Abominable" },
        { (ElementType.Eldritch, ElementType.Time), "Beyond Time" },
        { (ElementType.Eldritch, ElementType.Radioactivity), "Void Radiation" },
    };
    ...
    private ElementType GetElementFromSynergy(string synergy)
    {
        ...
        {
            "Contaminated" => ElementType.Radioactivity,
            "Mutated" => ElementType.Flesh,
            "Irradiated Growth" => ElementType.Fungus,
            "Necrotic" => ElementType.Fungus,
            "Virulent" => ElementType.Toxin,
            "Bioluminescent" => ElementType.Fungus,
            "Fusion" => ElementType.Thermodynamics,
            "Entropy" => ElementType.Time,
            "Cosmic" => ElementType.Eldritch,
            "Sustenance" => ElementType.Food,
            "Fermented" => ElementType.Food,
            "Abominable" => ElementType.Eldritch,
            "Beyond Time" => ElementType.Eldritch,
            "Void Radiation" => ElementType.Radioactivity,
            _ => ElementType.Eldritch
        };
    }
